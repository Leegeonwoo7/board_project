...
<form action="update.jsp" id="update_form" method="post">
    <table>
        <tr>
            ...
            <td>
                <input type="text" name="name" id="update_name" value="<%=memberDTO.getName()%>">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="id" id="update_id" value="<%=memberDTO.getId()%>" readonly>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="email" id="update_email" value="<%=memberDTO.getEmail()%>">
                <label for="update_email_addr">@</label>
                <input type="text" name="email_addr" id="update_email_addr" value="<%=memberDTO.getEmailAddr()%>">
        ...
        <tr>
            ...
            <td><input type="text" name="phone" id="update_phone" value="<%=memberDTO.getPhone()%>"></td>
        </tr>

        <tr>
            <th><label for="update_address_code">주소</label></th>
            <td>
                <input type="text" name="address_code" id="update_address_code" value="<%=memberDTO.getAddr1()%>">
                <input type="button" onclick="checkPost()" value="우편번호검색">
                <br>
                <input type="text" name="address_address" id="update_address" value="<%=memberDTO.getAddr2()%>"><br>
                <input type="text" name="address_address_detail" id="update_address_detail" value="<%=memberDTO.getAddr3()%>"><br>
            </td>
        </tr>
        <tr>
